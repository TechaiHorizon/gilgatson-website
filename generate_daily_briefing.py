#!/usr/bin/env python3
"""
Daily Tech Briefing Generator for gilgatson.com
Fetches news from Hacker News, Techmeme, and Reuters, then generates a briefing article.
"""
...
Format your response as a JSON array with objects containing: headline, url, summary"""
            },
            {
                "role": "user",
...
def save_article(content, date_str, formatted_date):
    """Save the article to the blog directory."""
...
def main():
    """Main execution flow."""
    print("=" * 60)
    print("Gil Gatson Daily Tech Briefing Generator")
    print("=" * 60)
    ...
    print("\n💾 Saving article...")
    try:
        filepath = save_article(article_content, date_str, formatted_date)
    except Exception as e:
